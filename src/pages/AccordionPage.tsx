  ...
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-4">
        ...
        <Accordion.Root defaultValue={['item-1']} className="space-y-2">
          <Accordion.Item
            value="item-1"
      ...
      <section className="space-y-4">
        ...
        <Accordion.Root defaultValue={['d-1']} className="space-y-2">
          <Accordion.Item
            value="d-1"
            className="border border-gray-200 rounded-lg overflow-hidden"
          >
          ...
          <Accordion.Item
            value="d-2"
            disabled
            className="border border-gray-200 rounded-lg overflow-hidden opacity-50"
          >
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-800">
          With Animation (usePresence)
        </h2>
        <p className="text-sm text-gray-600">
          Uses{' '}
          <code className="bg-gray-200 px-1 rounded">data-transition</code> from
          usePresence: starting → idle → ending
        </p>
        <style>{`
          .animated-content {
            display: grid;
        ...
        `}</style>
        <Accordion.Root defaultValue={['anim-1']} className="space-y-2">
          <Accordion.Item
            value="anim-1"
            ...
            <Accordion.ItemContent className="animated-content">
              <div>
                <div className="px-4 py-3 bg-white text-gray-700">
                  ...
                  <br />• <code>ending</code> → closing animation (stays mounted
                  until done)
                </div>
              </div>
            </Accordion.ItemContent>
          ...
          >
            ...
            <Accordion.ItemContent className="animated-content">
              <div>
                <div className="px-4 py-3 bg-white text-gray-700">
                  The key is that <code>usePresence</code> keeps the element
                  mounted during the exit animation (
                  <code>data-transition="ending"</code>).
                  <br />
                  <br />
                  Without usePresence, the element would unmount immediately and
                  you wouldn't see the closing animation.
                </div>
              </div>
            </Accordion.ItemContent>
          </Accordion.Item>
      ...
      <section className="p-4 bg-gray-800 text-white rounded-lg">
        ...
        <ul className="text-sm space-y-1 text-gray-300">
          ...
          <li>
            <kbd className="bg-gray-700 px-1 rounded">Arrow Down</kbd> /{' '}
            <kbd className="bg-gray-700 px-1 rounded">Arrow Up</kbd> - Navigate
            between triggers
          </li>
          <li>
            <kbd className="bg-gray-700 px-1 rounded">Home</kbd> - Focus first
            trigger
          </li>
          <li>
            <kbd className="bg-gray-700 px-1 rounded">End</kbd> - Focus last
            trigger
          </li>
        </ul>
      </section>
